module {
  public let challenges : [(Text, Text)] = [
    ...
    ("Clean up the apps on your phone", "The mess on your phone deterioates your focus. Do you really need 3 QR readers?"),
    ...
    ("Start your day with 50 sit ups for 10 days.", "Repeatition is the key to forming habbits."),
